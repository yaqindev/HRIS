...
<body>
			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h1 class="mb" align="center">Performance Appraisal</h1>
						<div class="row">
							<div class="col-md-11">
						...
						<div class="row">
							<div class="col-md-11">
								...
								<div class="form-group row" >
									<div class="col-md-offset-2 col-md-4" >
										<button class="btn btn-primary" onclick="set_box_performance_appraisal()">
											Process
										</button>
									</div>
								</div>
							...
							<br>
						<div id="box_performance_appraisal">							
						</div>
						<!-- end #box_performance_appraisal -->
					</div>	
				</div><!-- end.col-lg-12 -->
			</div><!-- end.row mt -->
		</section>
	...
	<script>
		function set_employee()
		{
			...
			{
				$.ajax({
					url 	:'<?php echo base_url() ?>performance/performance_appraisal_act/set_employee',
					type 	:'post',
		...
		function set_box_performance_appraisal()
		{
			var department 	= $("#department_search").val();
			...
			{
				$.ajax({
					url 	:'<?php echo base_url() ?>performance/performance_appraisal_act/set_box_appraisal',
					type 	:'post',
					data 	:{'department':department,'karyawan':karyawan,'periode':periode,'tahun':tahun},
					success : function(r)
					{
						$("#box_performance_appraisal").html(r);
					},
					error 	: function(r)
					{
						alert("Sistem Error , Please contact administrator !"+r);
